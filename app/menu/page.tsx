  ...
  const menuCategories = [
      ...
      items: [
        {
          ...
          description: "A selection of hummus, tapenade, olives, and fresh vegetables with warm pita bread.",
          price: "$18",
        ...
        },
        {
          ...
          description: "Hand-rolled grape leaves filled with rice, herbs, and aromatic spices.",
          price: "$12",
          image: "/placeholder.svg?height=200&width=300",
        },
      ],
    },
    {
      ...
      items: [
        ...
        {
          name: "Lamb Souvlaki",
          description: "Tender lamb skewers marinated in Mediterranean herbs, served with tzatziki.",
          price: "$32",
          image: "/placeholder.svg?height=200&width=300",
        },
      ],
    },
    {
      ...
      items: [
        ...
        {
          name: "Baklava",
          description: "Traditional layered pastry with nuts and honey, a Mediterranean classic.",
          price: "$10",
          image: "/placeholder.svg?height=200&width=300",
        },
        {
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Discover our carefully crafted dishes, each telling its own unique story of flavor and tradition.
          </p>
        </div>
      </section>
