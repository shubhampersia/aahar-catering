  ...
  const chefs = [
    {
      ...
      specialties: ["Mediterranean Cuisine", "Fusion Cooking", "Menu Development", "Team Leadership"],
      achievements: [
    ...
    },
    {
      ...
      specialties: ["Seafood Preparation", "Vegetarian Cuisine", "Sauce Making", "Kitchen Management"],
      achievements: [
        "CIA Honor Graduate",
    ...
    },
    {
      ...
      specialties: ["French Pastries", "Italian Desserts", "Chocolate Work", "Bread Making"],
      achievements: [
    ...
    },
    {
      ...
      specialties: ["Kitchen Operations", "Staff Training", "Quality Control", "Inventory Management"],
      achievements: [
    ...
    },
    {
      ...
      specialties: ["Ingredient Preparation", "Knife Skills", "Food Presentation", "Recipe Development"],
      achievements: [
    ...
    },
    {
      ...
      specialties: ["Event Catering", "Large Scale Cooking", "Menu Scaling", "Presentation Design"],
      achievements: [
    ...
    <div className="pt-16">
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Meet Our Chefs</h1>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Our talented team of culinary artists brings passion, creativity, and expertise to every dish we serve.
          </p>
        </div>
      </section>
            ...
            {chefs.map((chef, index) => (
              ...
              >
                ...
                <div className={index % 2 === 1 ? "md:col-start-1" : ""}>
                  <h2 className="text-3xl font-bold text-gray-900 mb-2">{chef.name}</h2>
                  <p className="text-xl text-orange-500 font-medium mb-4">{chef.role}</p>
                  <p className="text-gray-600 mb-6 leading-relaxed">{chef.bio}</p>
